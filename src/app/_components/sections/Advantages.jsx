...
const AdvantagesSection = () => {
  return (
    <>
        {/* advantages */}
        <section className="mil-relative" style={{ marginTop: '40px', paddingTop: '20px' }}>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="mil-center mil-mb-60">
                            <span className="mil-suptitle mil-upper mil-up mil-mb-20" dangerouslySetInnerHTML={{__html : Data.subtitle}} />
                            <h2 className="mil-upper mil-up mil-mb-20" dangerouslySetInnerHTML={{__html : Data.title}} />
