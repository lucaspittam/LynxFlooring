        ...
        const observer = new IntersectionObserver(
            ([entry]) => {
                if (entry.isIntersecting && counterRef.current) {
                    const target = parseInt(counterRef.current.getAttribute('data-number'));
                    let count = 0;
                    ...
                    <div className="row justify-content-between align-items-center flex-sm-row-reverse">
                        <div className="col-lg-5">
                            ...
                            <div className="mil-mb-90 mil-about-content mil-fade-in">
                                ...
                                <p className="mil-up mil-mb-40 mil-text-reveal" dangerouslySetInnerHTML={{__html : Data.description}} />
                                <Link href={Data.button.link} className="mil-link mil-upper mil-up mil-link-hover">
                                    {Data.button.label} 
                                    <span className="mil-arrow mil-arrow-animated"><img src="/img/icons/2.svg" alt="arrow" /></span>
                                </Link>
                            </div>
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="mil-illustration mil-up mil-mb-90 mil-about-image">
                                ...
                                <div className="mil-about-counter mil-counter-box">
                                    <h1 className="mil-counter mil-right mil-mb-10" data-number={Data.number.value} ref={counterRef}>0</h1>
