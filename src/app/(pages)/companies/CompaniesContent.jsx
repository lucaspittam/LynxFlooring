                          ...
                          >
                            ...
                            >
                              {new Date().getFullYear() -
                                companyHighlights[company.id].yearsFounded}
                            </div>
                            <div
                              style={{
                                fontSize: "14px",
                  ...
                  >
                    ...
                    >
                      <div className="mil-company-header">
                        ...
                        <p className="mil-company-location">
                          {company.location}
                        </p>
                        <p className="mil-company-description">
                          {company.description}
                        </p>
                      </div>
                          ...
                          <div className="row g-4">
                            {company.projects
                              ...
                              .map((project, index) => (
                                <div
                                  key={index}
                                  className={`${activeCompany === "all" ? "col-6" : "col-lg-6"}`}
                                >
